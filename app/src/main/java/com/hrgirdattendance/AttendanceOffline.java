...
public class AttendanceOffline extends AppCompatActivity implements MFS100Event {
   ...
   /* static int app_mode_att = UrlActivity.app_mode;*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = AttendanceOffline.this.getApplicationContext();
        ...
        receiver = new NetworkChange()
        {
            ...
            protected void onNetworkChange()
            {
                if (receiver.isConnected)
                {
                    ...
                    //internetConnection.showNetDisabledAlertToUser(AttendanceOffline.this);
    ...
    public void onControlClicked(View v)
    {
        switch (v.getId())
        {
            case R.id.btnForLoop:
                Toast.makeText(AttendanceOffline.this, "Loop for init->uninit->init... 500 times", Toast.LENGTH_LONG).show();
                i = 0;
    ...
    public void sync_data()
    {
        ...
        if(temp_sm_signinout != null)
        {
            ...
            if (!contacts.isEmpty())
            {
                ...
                {
                    Toast.makeText(AttendanceOffline.this, "No Records Found", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    if (first_hit) {
                        progressDialog = ProgressDialog.show(AttendanceOffline.this, "Please Wait", "Uploading Data... ", true);
                    }
                ...
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        if (progressDialog != null && progressDialog.isShowing()) {
                            ...
                            Toast.makeText(AttendanceOffline.this, message, Toast.LENGTH_SHORT).show();
                        }
        ...
        catch (SocketTimeoutException e)
        {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (progressDialog != null && progressDialog.isShowing()) {
                        progressDialog.dismiss();
                        Toast.makeText(AttendanceOffline.this, "Slow internet connection", Toast.LENGTH_SHORT).show();
                    }
                }
            });
...
//		SetLogOnUIThread("EndTime: " + getCurrentTime());
            ...
            protected void onPostExecute(String result)
            {
                ...
                try
                {
                    String t1 = "", t2 = "", t3 = "", t4 = "", uid,
                            ufname, ulname, u_mobile_nu, ucid="", att_type="", att_shift="";
                    ...
                    for (UserDetails_Model cn : contacts)
                    {
                        ...
                        String id_value = ed_MobNo.getText().toString();

                        if (id_value.length() == 10)
                        {
                            if ((u_mobile_nu.equalsIgnoreCase(ed_MobNo.getText().toString())))
                            {
                                if (att_type.equals("1"))
                                {
                                    ...
                                    /*}
                                        ...
                                        txt_success.setText("Roaster EMP attendance not allowed\n");
                                        ...
                                        handler.postDelayed(new Runnable() {
                                            @Override
                                            public void run() {
                                                Log.i("MFS_Log Roaster", "Roaster EMP attendance not allowed");
                                                txt_matchMsg.setText("");
                                                txt_success.setText("");
                                                ed_MobNo.setText("");
                                                img_Match.setImageResource(R.drawable.imagefinger);
                        ...
                        else
                        {
                            ...
                            if (responseCode.equals("1"))
                            {
                                cid_temp = get_prefix.concat(id_value);
                                Log.i("cid_temp", cid_temp);
                            }
                            else {
                                cid_temp = id_value;
                                Log.i("cid_temp", cid_temp);
                            ...
                            if ((ucid.equalsIgnoreCase(cid_temp)))
                            {
                                if (att_type.equals("1"))
                                {
                                    /*if (att_shift.equals("1") || att_shift.equals("3")) {
            ...
            if(in_out_date != null)
            {
                ...
                if(InDateTimen.equals(attDateTimen))
                {
                    if (in_out_id.equals("1"))
                    {
                        ...
                        ed_MobNo.setText("");
                        txt_matchMsg.setText("Unsuccessful");
                        txt_success.setText("You are already SignIn");
        ...
        else if (inout.equals("2"))
        {
            ...
            if(in_out_date == null)
            {
                if (InDateTimen.equals(attDateTimen))
                {
                    ...
                    ed_MobNo.setText("");
                    txt_matchMsg.setText("Unsuccessful");
                    txt_success.setText("You are Not SignIn");
            ...
            if(in_out_date != null)
            {
                if(InDateTimen.equals(attDateTimen))
                {
                    if (in_out_id.equals("2"))
                    {
                        ...
                        ed_MobNo.setText("");
                        txt_matchMsg.setText("Unsuccessful");
                        txt_success.setText("You are already SignOut");
    ...
    public void popup_window(View v)
    {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) AttendanceOffline.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            btn_login.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    if (internetConnection.hasConnection(getApplicationContext()))
                    {
                        ...
                        {
                            Toast.makeText(AttendanceOffline.this, "Please enter username & password", Toast.LENGTH_LONG).show();
                        }
                        else if (UserName.equals(""))
                        {
                            Toast.makeText(AttendanceOffline.this, "Please enter username", Toast.LENGTH_LONG).show();
                        }
                        else if (Password.equals(""))
                        {
                            Toast.makeText(AttendanceOffline.this, "Please enter password", Toast.LENGTH_LONG).show();
                        }
                        else {
                            signIn();
                        }
                        ...
                        Toast.makeText(AttendanceOffline.this, "Please check your internet connection", Toast.LENGTH_LONG).show();
                    }
                }
            });
    ...
    public void signIn()
    {
        class GetDataJSON extends AsyncTask<String, Void, String>
        {
            ...
            {
                progressDialog = new ProgressDialog(AttendanceOffline.this, ProgressDialog.THEME_HOLO_LIGHT);
            ...
            protected void onPostExecute(String result)
            {
                ...
                {
                    progressDialog.dismiss();
                    Toast.makeText(AttendanceOffline.this, "Sorry... Slow internet connection", Toast.LENGTH_LONG).show();
                }
                else
                {
                    try
                    {
                        ...
                        if (responsecode.equals("1"))
                        {
                            ...
                            /*mfs100.StopCapture();
                            Intent intent = new Intent(AttendanceOffline.this, MainActivity.class);
                        ...
                        else
                        {
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(AttendanceOffline.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
